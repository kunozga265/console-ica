    ...
    <AppLayout title="Register">
        ...
        <template #actions>
            ...
            <button data-modal-target="crud-modal" data-modal-toggle="crud-modal"
                class="block text-white bg_green_500  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                type="button">
                + Record Attendance
            </button>
                    ...
                    <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                        ...
                        <form class="p-4 md:p-5">
                            <div class="">
                                ...
                                <div class="mb-4 h-48 overflow-auto">
                                    <div class="text-gray-500 text-xs">Teen Results</div>

                                    <div class="text-gray-500 text-xs">Other Results</div>
